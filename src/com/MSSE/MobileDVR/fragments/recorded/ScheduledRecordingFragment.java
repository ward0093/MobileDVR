...
//        });
    ...
    public class ScheduledRecordingAdapter extends ArrayAdapter<ScheduledRecording> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (sr != null ) {
                ((TextView)item.findViewById(R.id.item_name)).setText(sr.getShowInfo().getTitle());
                ((TextView)item.findViewById(R.id.item_title)).setText(sr.getShowInfo().getDescription());
                ((TextView)item.findViewById(R.id.item_phone)).setText(sr.getOriginalAirtime().toString());
            }
